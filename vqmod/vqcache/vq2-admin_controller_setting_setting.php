...
if ($this->config->get('config_maintenance_dialog_page_background') && file_exists(DIR_IMAGE . $this->config->get('config_maintenance_dialog_page_background')) && is_file(DIR_IMAGE . $this->config->get('config_maintenance_dialog_page_background'))) {
